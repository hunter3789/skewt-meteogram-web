...
var mto = function fnMtoDisp(ds, timebarContainer, chartContainer, skewTimeContainer, skewImageContainer) {
  ...
  var margin = {top: 45, right: 35, bottom: 30, left: 50};
  var marginNavi = {top: 20, right: 35, bottom: 20, left: 50};
  ...
  function drawGraph(ctx, width, height, margin){
    ...
    ctx.fillText("precip. / h", 25, margin.top-20);
    ...
    ctx.setLineDash([4,2]);
    ctx.beginPath();
    ctx.moveTo(margin.left + width - 60, margin.top-22);
